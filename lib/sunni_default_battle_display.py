...
def default_battle_display(screen, font, battle_background_hallway, health_icon, mana_icon, options_button,
    ...
    if (Keys.escape or (mousein(mouse_x, mouse_y, 10,665,100,715) and left == 1)) and not display_options and current != "choose_character": # Focus on choosing your character!
